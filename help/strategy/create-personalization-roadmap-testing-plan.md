...
때로는 브랜드 가치 또는 충성도와 같이 처음에 무형으로 보이는 목표가 있을 수 있습니다. Personalization 활동의 목표 지표로 사용하려면 이러한 지표를 측정할 수 있어야 합니다. 일반적으로 이러한 유형의 목표는 라이프타임 고객 가치 또는 구매 비용과 같은 매출 영향과 연계될 수 있습니다.진행함에 따라 주요 비즈니스 목표에 따라 프로그램 성능을 주기적으로 검토하여 Personalization 프로그램에서 가치를 창출하도록 해야 합니다.
