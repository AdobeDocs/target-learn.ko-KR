...
+ 관리{#administration}
   ...
   + [계정 환경 설정 지정](../administration/set-up-account-preferences.md)
   + [엔터프라이즈 사용자 권한 이해](../administration/understanding-enterprise-user-permissions.md)
...
+ 구현{#implementation}
   ...
   + [사용자 동의를 기반으로 Experience Cloud 솔루션을 제어하려면 옵트인을 사용합니다.](https://docs.adobe.com/content/help/en/core-services-learn/tutorials/id-service/use-opt-in-to-control-experience-cloud-activities-based-on-user-consent.html)
...
+ 통합{#integrations}
   ...
   + [데이터 위치:데이터 공급자를 사용하여 제3자 데이터 통합](../integrations/use-data-providers-to-integrate-third-party-data.md)
   + [데이터 위치:데이터 제공업체를 구현하여 제3자 데이터 통합](../integrations/implement-data-providers-to-integrate-third-party-data.md)
...
+ 활동{#activities}
   ...
   + [인공 지능(AI) 및 자동화 기능을 사용하여 개인화의 당면 과제 해결](../activities/use-the-artificial-intelligence-and-automation-capabilities-to-meet-the-challenges-of-personalization.md)
...
+ 대상자{#audiences}
   + [대상자 사용](../audiences/use-audiences.md)
   + [프로필 스크립트 만들기](../audiences/create-profile-scripts.md)
   + [프로필 비교를 사용하여 대상자 만들기](../audiences/use-profile-comparison-to-build-audiences.md)
...
+ 권장 사항{#recommendations}
   ...
   + [맞춤형 디자인 만들기](../recommendations/create-custom-designs.md)
...
+ 모바일{#mobile}
   + [Android용 Adobe Mobile Services SDK v4와 함께 Adobe Target 구현](../mobile-v4/overview.md)
+ API{#apis}
