...
+ [Recommendations와 함께 배달 API 사용](https://experienceleague.adobe.com/docs/target-dev/developer/api/recommendations-api/fetch-recs-server-side-delivery-api.html?lang=ko){target="_blank"}
