...
1. **[!UICONTROL 제어 경험]**:어떤 경험이든 선택할 수 있습니다.그러나 나중에 이 선택을 무시합니다. [!DNL Auto-Target] 활동의 경우 제어 경험은 (a) 모든 경험들 사이에 임의로 제공되거나, b) 단일 경험을 제공하는 제어 전략입니다(이 선택 사항은 Adobe Target에서 활동 생성 시 수행됨). 선택 (b) - [!DNL Auto-Target] 활동이 특정 경험을 제어로 지정한 경우에도 [!DNL Auto-Target] 활동에 대한 A4T 분석을 위해 이 튜토리얼에 설명된 접근 방식을 따라야 합니다.
