...
1. 대상 이름으로 **[!UICONTROL 새 모바일 앱 사용자]**&#x200B;를 입력하십시오.
1. **[!UICONTROL 규칙 추가]**&#x200B;를 선택합니다.
1. **[!UICONTROL 사용자 지정]** 규칙을 선택하십시오.
...
1. **[!UICONTROL a를 사용합니다.시작이 사용자 지정 규칙인 5]**&#x200B;보다 크거나 같습니다.
1. 새 대상을 저장합니다.
...
>[!NOTE]
>
>[!DNL Target] 모바일 SDK에서 수집된 모든 라이프사이클 지표 및 차원은 앞에 &quot;a&quot;(예: a.Launches)가 있으며 드롭다운 메뉴의 &quot;사용자 지정&quot; 옵션에서 사용할 수 있으며 대상을 빌드하는 데 사용할 수 있습니다.
...
1. _돌아오신 것을 환영합니다! 체크아웃 중에 프로모션 코드 BACK30을 사용하여 10% 할인을 받으십시오._ HTML 코드.
1. 새 오퍼를 저장합니다.
