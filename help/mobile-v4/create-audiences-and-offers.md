...
>[!NOTE]
>
>모바일 SDK에서 수집된 모든 라이프사이클 지표 및 차원은 [!DNL Target] &quot;a&quot;(예: a.Launches)로 프리펜드되며 드롭다운 메뉴의 &quot;사용자 지정&quot; 옵션에서 사용할 수 있으며 대상을 빌드하는 데 사용할 수 있습니다.
...
>[!NOTE]
>
>사용자 지정 드롭다운에서 볼 매개 변수가 [!DNL Target] 인터페이스에 나타나지 않으면 요청에서 실제로 전달되고 있는지 다시 확인하십시오. 요청에 있지만 [!DNL Target] 인터페이스에 레이저가 로드되지 않은 것을 확인한 경우 매개 변수 이름을 입력하고 Enter 키를 눌러 대상을 계속 정의할 수 있습니다
