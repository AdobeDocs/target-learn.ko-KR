...
1. 기본 컨텐츠 옆의 드롭다운 화살표를 선택하고 **[!UICONTROL HTML 오퍼 변경]**&#x200B;을 선택합니다.

   ![새 모바일 앱 사용자 대상](assets/activity_create_5.jpg)

1. **[!UICONTROL 홈: 새 사용자 참여]** 오퍼를 선택하십시오.
...
1. **[!UICONTROL 검색: 새 사용자 참여]** 오퍼를 선택합니다.
1. **[!UICONTROL 완료를 클릭합니다]**.
...
1. **[!UICONTROL 목표 및 설정]**(으)로 이동하려면 **[!UICONTROL 다음]**&#x200B;을 클릭하세요.
...
1. 작업을 **[!UICONTROL mbox 확인함]** > _wetravel_ context_dest_(이 위치는 확인 화면에 있으므로 전환을 측정하는 데 사용할 수 있음)으로 설정합니다.
...
1. **[!UICONTROL 보고 설정]**&#x200B;에서 **[!UICONTROL 기본 목표]**&#x200B;를 **[!UICONTROL 전환]**(으)로 설정합니다.
1. 작업을 **[!UICONTROL mbox 확인함]** > _wetravel_ context_dest_(이 활동에서는 이 지표가 경험을 전달하는 동일한 위치이기도 하므로 기본적으로 의미 없음)으로 설정합니다.
...
새 사용자 오퍼가 표시되지 않으면 에뮬레이터에 대한 데이터를 삭제해 보십시오. 그러면 다음에 앱을 실행할 때 앱 시작이 1로 재설정됩니다. 이 작업은 **[!UICONTROL 도구]** > **[!UICONTROL AVD 관리자]**&#x200B;에서 수행됩니다. Logcat이 제대로 작동하지 않는 경우 Android Studio를 다시 시작해야 할 수도 있습니다.
...
**[!UICONTROL 산호세]**&#x200B;을(를) **[!UICONTROL 출발]**(으)로, **[!UICONTROL 샌디에이고]**&#x200B;을(를) **[!UICONTROL 목적지]**(으)로 선택하고 **[!UICONTROL 버스 찾기]**&#x200B;를 클릭하여 사용 가능한 버스를 검색합니다.
...
* 결과 화면에서 버스를 선택합니다.
* 체크아웃 화면에서 시트를 선택합니다.
* 결제 화면에서 **[!UICONTROL 신용 카드]**&#x200B;을(를) 선택하십시오(결제 정보를 비워 두십시오. 실제 예약은 수행되지 않습니다).

샌디에이고가 대상으로 선택되었으므로 확인 화면에 _DJ SAM_ 오퍼 배너가 표시됩니다.

![컨텍스트 오퍼 유효성 검사 - 샌디에이고](assets/layout_context_san_diego.jpg)

이제 **[!UICONTROL 완료]**&#x200B;를 선택하고 Los Angeles를 대상으로 다른 예약을 시도해 보세요. 확인 화면에 _Universal Studios_ 배너가 표시됩니다.
